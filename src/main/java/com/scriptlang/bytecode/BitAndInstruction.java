 ...
 * @author Dmitry
 */
public class BitAndInstruction extends BaseInstruction {
    ...
    public void execute(Interpreter interpreter) {
        ...
        throw new ExecutionException("Cannot make bit AND on two values of the following types: [" + left.variableType + "] and [" + right.variableType + "]");
    }
