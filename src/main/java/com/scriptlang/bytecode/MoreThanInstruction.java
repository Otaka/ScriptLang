 ...
 * @author Dmitry
 */
public class MoreThanInstruction extends BaseInstruction {
    ...
    public void execute(Interpreter interpreter) {
        ...
        if (left.variableType == VariableType.STRING && right.variableType == VariableType.STRING) {
            int compareResult = left.getAsString().compareTo(right.getAsString());
        ...
        throw new ExecutionException("Cannot compare two values of the following types: [" + left + "] and [" + right + "]");
    }
