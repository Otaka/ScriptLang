 ...
 * @author Dmitry
 */
public class BitXorInstruction extends BaseInstruction {
    ...
    public void execute(Interpreter interpreter) {
        ...
        throw new ExecutionException("Cannot make bit XOR on two values of the following types: [" + left.variableType + "] and [" + right.variableType + "]");
    }
